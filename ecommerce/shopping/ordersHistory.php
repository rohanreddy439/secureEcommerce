...
<?php
  $qry="select A.customername,A.mobile,A.email,B.productCode,B.paydate,B.amount from customers A,payments B where A.email=B.email and A.email='".$_SESSION['email']."'";
